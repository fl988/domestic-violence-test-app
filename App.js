...
Git Hub Command Line
  ...
  - 'git push origin master' to push it to the master file

  New Files and Folders
  - 'git status' to see the list of folders and files
  - 'git add <file OR folder>' to add it in to your local repository officially. Sample: git add components/CustomModal.js
